...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-slate-900 overflow-hidden text-slate-100 font-sans">
      ...
      {/* Animated micro-particles (subtle background element) */}
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 py-12 grid md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-5">
          <div className="bg-slate-800/40 backdrop-blur-md border border-slate-750 p-8 rounded-2xl shadow-2xl relative">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm mt-1">Sign in or register your account instantly</p>
              </div>
              ...
              <div className="text-xs text-slate-500 pt-2 border-t border-slate-700/40 w-full">
                New user? Click above to register automatically on your first login.
              </div>
            </div>
          </div>
        </div>
